...
if (! class_exists ( 'WSkroutz_Admin' )) {
    class WSkroutz_Admin
    {
        ...
        private $fields = array( 'inStock' => 'wskroutz_delivery_in_stock', 'outOfStock' => 'wskroutz_delivery_out_of_stock');
    ...
    return $links;
        ...
        public function register_options_init()
        {
            ...
            add_settings_section(
                                $section,
                                __('Delivery settings', $this->text),
                                array ($this, 'delivery_settings_section_callback'),
                                $this->settings_page);
            add_settings_field(
                                $this->fields['inStock'],
                                __('In Stock Products', $this->text),
                                array ( $this, 'in_stock_page_render' ),
                                $this->settings_page,
                                $section
                            );
                            
            add_settings_field(
                                $this->fields['outOfStock'],
                                __('Out Of Stock Products', $this->text),
                                array ( $this, 'out_of_stock_page_render' ),
                                $this->settings_page,
                                $section
                            );
        ...
        public function in_stock_page_render($args)
        {
            ...
            <option <?php selected( $options[$this->fields['inStock']], '1' ); ?> value='1'><?php _e( 'Available in store / Delivery 1 to 3 days', $this->text ); ?></option>
            <option <?php selected( $options[$this->fields['inStock']], '2' ); ?> value='2' ><?php _e( 'Delivery 1 to 3 days', $this->text ); ?></option>
            <option <?php selected( $options[$this->fields['inStock']], '3' ); ?> value='3' ><?php _e( 'Delivery 4 to 10 days', $this->text ); ?></option>
            <option <?php selected( $options[$this->fields['inStock']], '4' ); ?> value='4' ><?php _e( 'Upon order', $this->text ); ?></option>
        </select>
        ...
        public function out_of_stock_page_render($args)
        {
            ...
            <option <?php selected( $options[$this->fields['outOfStock']], '2' ); ?> value='2' ><?php _e( 'Delivery 1 to 3 days', $this->text ); ?></option>
            <option <?php selected( $options[$this->fields['outOfStock']], '3' ); ?> value='3' ><?php _e( 'Delivery 4 to 10 days', $this->text ); ?></option>
            <option <?php selected( $options[$this->fields['outOfStock']], '4' ); ?> value='4' ><?php _e( 'Upon order', $this->text ); ?></option>
            <option <?php selected( $options[$this->fields['outOfStock']], '5' ); ?> value='5' ><?php _e( 'Do not show', $this->text ); ?></option>
        </select>
